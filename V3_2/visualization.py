            ...
            for section_id, section in dashboard_sections.items():
                ...
                if section_id == 'training_stats':
                    ...
                    for i, stat in enumerate(col2_stats):
                        stat_surface = regular_font.render(stat, True, WHITE)
                        combined_screen.blit(stat_surface, (section['rect'].x + 200, section['rect'].y + 30 + i * 18))
                    ...
                    col2_stats = [
                        ...
                        f"Entropy: {current_metrics['entropy_coef']:.4f}",
                        f"Loss: {current_metrics['last_loss']:.4f}",
                        f"A/C Loss: {current_metrics['actor_loss']:.2f}/{current_metrics['critic_loss']:.2f}"
                    ]
                    ...
                    if current_metrics['avg_rewards']:
                    ...
                    if current_frame['car'] and hasattr(current_frame['car'], 'sensor_readings'):
                        ...
                        for i in range(4):
                            ...
                            # Add distance label
                            if i > 0:
                                dist_label = name_font.render(f"{int(MAX_SENSOR_DISTANCE * i / 4)}", True, LIGHT_GRAY)
